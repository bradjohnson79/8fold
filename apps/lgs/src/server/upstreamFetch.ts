...
const DEFAULT_TIMEOUT_MS = parsePositiveInt(process.env.LGS_UPSTREAM_TIMEOUT_MS, 8000);
...
export async function fetchWithLgsTimeout(input: string | URL, init?: RequestInit): Promise<Response> {
