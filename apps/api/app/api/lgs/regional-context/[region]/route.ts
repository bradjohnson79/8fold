/**
 * LGS isolation boundary (Directory Intelligence & Submission Engine).
 *
...
export async function GET(
  ...
  try {
    ...
    console.error("LGS regional-context get error:", err);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("LGS regional-context patch error:", err);
    return NextResponse.json({ ok: false, error: String(err) }, { status: 500 });
  }
}
