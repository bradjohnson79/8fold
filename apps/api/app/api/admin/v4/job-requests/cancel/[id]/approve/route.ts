...
export async function POST(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    await adminAuditLog(
      ...
      {
        action: "JOB_CANCEL_REQUEST_APPROVED",
    ...
    console.error("[ADMIN_V4_CANCEL_APPROVE_ERROR]", { message: e instanceof Error ? e.message : String(e) });
    return err(500, "ADMIN_V4_CANCEL_APPROVE_FAILED", "Failed to approve cancel request");
  }
}
