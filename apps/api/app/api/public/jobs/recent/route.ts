...
import { withApiHandler } from "../../../../../src/server/withApiHandler";
...
export const GET = withApiHandler(async (req, ctx) => {
  ...
  if (!parsed.success) return badRequest("invalid_query", { requestId: ctx.requestId });
  ...
  return ok({ jobs: out }, { requestId: ctx.requestId });
});
