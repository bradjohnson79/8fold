...
export async function GET(req: Request) {
  try {
    ...
    console.error("PUBLIC_DISCOVERY_ERROR", { route: "/api/public/locations/cities", error: err });
    return NextResponse.json({ ok: false, error: "PUBLIC_DISCOVERY_FAILED" }, { status: 500 });
  }
}
