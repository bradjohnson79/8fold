          ...
          {jobs.map((j) => (
            <JobCard
              ...
              job={{
                ...
                title: j.title,
                region: j.region ?? "",
                country: ((j as { country?: string }).country ?? "US") as "US" | "CA",
                currency: ((j as { currency?: string }).currency ?? ((j as { country?: string }).country === "CA" ? "CAD" : "USD")) as "USD" | "CAD",
                ...
                brokerFeeCents: (j as { brokerFeeCents?: number }).brokerFeeCents ?? (j as { platformFeeCents?: number }).platformFeeCents ?? 0,
