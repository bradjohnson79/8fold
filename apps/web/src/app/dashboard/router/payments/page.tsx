...
export default function RouterPaymentsPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">Connect Stripe to receive routing commission payouts.</p>
      </div>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          >
            {isVerified ? "Connected" : isPending ? "Pending Verification" : mismatch ? "Currency Mismatch" : "Not Connected"}
          </span>
        </div>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-slate-900">Stripe Onboarding</h2>
        ...
        {notConnected ? (
          <div className="mt-3 max-w-sm">
            ...
            <select
              ...
              className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-800 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
            >
        ...
        <div className="mt-4">
          <button
            ...
            className="rounded-lg bg-[#635BFF] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#5349e8] disabled:cursor-not-allowed disabled:opacity-50"
          >
            {saving
              ? "Redirecting..."
              : isPending
