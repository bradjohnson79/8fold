...
export default function JobPosterMessagesPage() {
  ...
  return (
    <div className="p-6">
      ...
      <p className="mt-1 text-slate-600">Communicate with your assigned contractor.</p>
        ...
        {selectedThread ? (
          <details className="border-t border-slate-200 px-4 py-3">
            ...
            <div className="mt-3 space-y-1 text-sm text-slate-700">
              ...
              <p><span className="font-medium">Business:</span> {selectedThread.contractorBusinessName || "Contractor Business"}</p>
              <p><span className="font-medium">Trade:</span> {selectedThread.tradeCategory || "General"}</p>
              ...
              <p><span className="font-medium">Availability:</span> {selectedThread.availability || "Availability not provided"}</p>
      ...
      <div className="mt-4">
        <Link href="/dashboard/job-poster" className="text-sm font-medium text-emerald-700 hover:text-emerald-800">
          Back to Job Poster Dashboard
        </Link>
      </div>
    </div>
  );
